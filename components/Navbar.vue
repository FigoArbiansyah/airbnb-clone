<template>
  <nav class="py-6 px-[35px] sticky top-0">
    <div class="flex justify-between">
      ...
      <div
        class="flex items-center rounded-full py-3 pl-2 pr-2 shadow border font-[500] cursor-pointer hover:shadow-lg transition-all ease"
      >
